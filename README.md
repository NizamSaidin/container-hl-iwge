...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hl-iwge.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hl-iwge.containers.anotherwebservice.com/
...
```
git clone git@github.com:NizamSaidin/container-hl-iwge.git
cd container-hl-iwge
```
...
```
docker attach container-hl-iwge
```
